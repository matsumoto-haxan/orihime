        ...
        <div class="col-md-10">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <button class="main_func_button" onclick="location.href='/management'">出荷管理表</button>
                    <button class="main_func_button" onclick="location.href='/instruction'">出荷依頼書</button>
